...
| P2-05 | P2 ⭐⭐⭐⭐⭐ | **IDI Engine — Investigation Document Intelligence.** Ingestion adapter layer that turns Cisco XDR / CrowdStrike / Defender / QRadar / Splunk / Sysmon / Windows Event / etc. into the CIO. NOT a parallel pipeline — adapters feed the shared verdict engine and CIO. See `/app/docs/architecture/04_INVESTIGATION_CONSTITUTION.md`. | ⏳ Pending | Foundational P2 item · builds on P1-01 + P1-02. |
