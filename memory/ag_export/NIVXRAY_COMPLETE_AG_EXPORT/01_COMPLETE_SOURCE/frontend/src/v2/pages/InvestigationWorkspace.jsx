...
const SecurityStateTab   = lazy(() => import("./SecurityStateTab"));
...
function InvestigationWorkspaceInner() {
  ...
  const TABS = useMemo(() => ([
    ...
    { key: "security_state", label: "Security State & Causal", testid: "tab-security-state",
      render: () => <SecurityStateTab inv={inv} />,
    },
