...
async def investigation(case_id: str, limit: int = 500,
    ...
    # P5-A / P5-B: Non-blocking shadow dispatch (zero overhead if disabled)
    maybe_dispatch_security_state_shadow(case_id=case_id, tenant_id="default", frames=fdicts, ikg=inv.ikg)
