...
_BINARY_MAGIC = (
    ...
    (b"7z\xbc\xaf\x27\x1c", "Archive", "7-Zip compressed archive"),
    (b"Rar!\x1a\x07", "Archive", "RAR compressed archive"),
    (b"MSCF",         "Archive", "Microsoft Cabinet archive"),
    (b"**ACE**",      "Archive", "ACE compressed archive"),
    (b"\x1f\x8b\x08", "GZIP",     "raw gzip stream"),
    # Common shellcode prologues
    (b"\xfc\xe8",     "Shellcode", "x86/x64 Metasploit/Cobalt Strike stager"),
    (b"\xfc\xeb",     "Shellcode", "x86/x64 shellcode jmp entry"),
    (b"\xfc\x48\x83\xe4\xf0", "Shellcode", "x64 stack-aligned shellcode"),
    (b"\x31\xc0\x50", "Shellcode", "x86 shellcode entry"),
    (b"\x65\x48\x8b", "Shellcode", "x64 TEB/PEB access shellcode"),
    (b"\x64\xa1",     "Shellcode", "x86 TEB/PEB access shellcode"),
    (b"\xff\xb5",     "Shellcode", "ARM/Thumb shellcode prologue"),
    (b"\xfd\x7b",     "Shellcode", "ARM64 shellcode frame setup"),
)
