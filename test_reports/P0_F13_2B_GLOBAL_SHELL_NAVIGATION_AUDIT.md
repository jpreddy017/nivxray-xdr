# P0-F.13.2B — Global shell + navigation parity (companion to the consolidated audit)

Full findings: `p0_f13_2b_global_shell_navigation_audit.json`.
Sections 3, 4 and 5 below are the shell/navigation findings;
sections 1 and 2 are shared context.
