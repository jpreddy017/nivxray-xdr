...
_L_DEFAULT: List[Dict[str, Any]] = [
    ...
    {"bin": "powershell.exe", "argv": r"-e(?:c|(?:n(?:c(?:o(?:d(?:e(?:d(?:c(?:o(?:m(?:m(?:a(?:nd?)?)?)?)?)?)?)?)?)?)?)?)?)?\s|-w\s*hidden|-nop\b|iex\b|invoke-expression|downloadstring|downloadfile|get-process|get-service|frombase64string",
     "purposes": ["Execute"], "mitre": ["T1059.001"],
     "desc": "PowerShell with encoded/hidden/download-and-execute or discovery pattern"},
